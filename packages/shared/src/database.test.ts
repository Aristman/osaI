  ...
  describe('TT-005-06: Idempotent init', () => {
    ...
    it('should preserve data on repeated init', () => {
      ...
      manager
        .getDb()
        .prepare(
          'INSERT INTO chats (id, name, channel) VALUES (?, ?, ?)'
        )
      ...
      const chat = manager
        ...
        .get('test-chat-1') as Record<string, unknown> | undefined;
  ...
  describe('TT-005-07: Migration framework versioning', () => {
    ...
    it('should not re-apply already applied migrations', () => {
      ...
      const chat = manager
        .getDb()
        .prepare('SELECT * FROM chats WHERE id = ?')
        .get('test-idempotent') as Record<string, unknown> | undefined;
  ...
  describe('TT-005-08: Parameterized queries', () => {
    ...
    it('should record migrations using parameterized INSERT', () => {
      ...
      const row = manager
        ...
        .get(1) as { version: number; description: string } | undefined;
