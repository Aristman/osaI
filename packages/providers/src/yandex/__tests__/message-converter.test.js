...
import { toYandexMessages, toYandexCompletionOptions, fromYandexResponse, fromYandexAlternative, } from '../message-converter.js';
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
function makeYandexAlternative(text, status) {
    return {
        message: {
            role: 'assistant',
            text,
