...
describe('DocumentFormat', () => {
  ...
  it('should have exactly three format values', () => {
    const values = Object.values(DocumentFormat) as string[];
...
describe('InsertKnowledgeDocument', () => {
  it('should accept minimal required fields', () => {
    const insert: InsertKnowledgeDocument = {
      id: 'doc-004',
      title: 'New Doc',
      path: '/tmp/new.txt',
      format: DocumentFormat.Txt,
...
describe('UpdateKnowledgeDocument', () => {
  it('should accept partial updates', () => {
    const update: UpdateKnowledgeDocument = { title: 'Updated Title' };
    expect(update.title).toBe('Updated Title');
  });

  it('should accept multiple fields', () => {
    const update: UpdateKnowledgeDocument = {
      status: DocumentStatus.Completed,
      chunksCount: 10,
      tags: ['api', 'v2'],
    };
...
describe('ListDocumentsFilter', () => {
  ...
  it('should accept format filter', () => {
    const filter: ListDocumentsFilter = { format: DocumentFormat.Pdf };
    expect(filter.format).toBe('pdf');
  });

  it('should accept tag filter', () => {
    const filter: ListDocumentsFilter = { tag: 'api' };
...
describe('DocumentStatus', () => {
  ...
  it('should have exactly four status values', () => {
    const values = Object.values(DocumentStatus) as string[];
...
describe('InsertKnowledgeChunk', () => {
  it('should accept all required fields', () => {
    const insert: InsertKnowledgeChunk = {
      id: 'chunk-002',
      documentId: 'doc-001',
...
describe('KBSearchConfig defaults', () => {
  ...
  it('should resolve partial config with defaults', () => {
    const config: KBSearchConfig = { topK: 3 };
  ...
  it('should resolve config with all fields', () => {
    const config: KBSearchConfig = { topK: 10, minSimilarity: 0.5, tags: ['api'] };
    const resolved = resolveKBSearchConfig(config);
...
describe('SourceInfo', () => {
  it('should accept all required fields', () => {
    const tag: SourceTag = { name: 'api', color: '#ff0000' };
  ...
  it('should accept tag without color', () => {
    const tag: SourceTag = { name: 'guide' };
    const info: SourceInfo = {
      documentId: 'doc-002',
      title: 'Guide',
      path: '/tmp/guide.txt',
