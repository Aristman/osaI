 ...
 */
function waitForConnection(wsServer) {
...
describe("GatewayClient", () => {
    ...
    describe("TT-001-04: osai --version", () => {
        it("should print version to stdout and exit 0", (done) => {
            ...
            execFile("node", [binPath, "--version"], (error, stdout) => {
        ...
        it("should print help with --help and exit 0", (done) => {
            const binPath = join(__dirname, "..", "..", "bin", "osai.js");
            execFile("node", [binPath, "--help"], (error, stdout) => {
                expect(error).toBeNull();
        ...
        it("should exit 1 for unknown command", (done) => {
            const binPath = join(__dirname, "..", "..", "bin", "osai.js");
            execFile("node", [binPath, "unknown-command"], (error, stdout, stderr) => {
    ...
    describe("additional behavior", () => {
        ...
        it("should throw when sending while not connected", () => {
            ...
            expect(() => client.send("test")).toThrow("Cannot send: WebSocket is not connected");
            client.disconnect();
        });
...
//# sourceMappingURL=gateway-client.test.js.map