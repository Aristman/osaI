 ...
 */
function addTestMessages(chatService, chatId, roles) {
...
describe("ChatContextManager", () => {
    ...
    describe("TT-009-28: WS notification on chat switch", () => {
        it("broadcasts on_chat_switch event to connected clients", () => {
            ...
            const firstCall = broadcastSpy.mock.calls[0][0];
            ...
            const secondCall = broadcastSpy.mock.calls[1][0];
            expect(secondCall["type"]).toBe("on_chat_switch");
            const payload2 = secondCall["payload"];
...
//# sourceMappingURL=ChatContextManager.test.js.map