...
import { MirrorEngine, telegramHtmlToMarkdown, } from "../mirror.js";
...
describe("MirrorEngine (TG-to-osai): receiveMessage", () => {
    ...
    it("should pass telegramMessageId to the injector", async () => {
        ...
        await engine.receiveMessage(msg, injector);
        expect(injector.injectMessage).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=mirror-tg-to-osai.test.js.map