 ...
 */
function createTestStorage(): VectorStorage {
...
describe('InMemoryVectorStorage', () => {
  it('should validate vector dimensions on upsert', () => {
    ...
    expect(() => s.upsert('bad', [1, 2, 3], {})).toThrow(
  ...
  it('should validate query vector dimensions on search', () => {
    ...
    expect(() => s.search([1, 2, 3], 5, 0.0)).toThrow(
      'Query vector dimension mismatch: expected 4, got 3',
    );
  });
