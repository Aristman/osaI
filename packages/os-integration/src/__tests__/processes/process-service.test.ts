...
} from "../../processes/process-service.js";

function createMockProvider(): ProcessesProvider {
  return {
...
describe("ProcessService", () => {
  let provider: ProcessesProvider;
  ...
  describe("error handling", () => {
    it("should throw when provider fails", async () => {
      vi.mocked(provider.processes).mockRejectedValue(
