...
// Helpers
// ---------------------------------------------------------------------------
function createMockKnowledgeBaseService() {
    return {
...
describe('KnowledgeBaseSkill', () => {
    ...
    describe('ingest_document (TC-008-1)', () => {
        ...
        it('passes format and tags to service', async () => {
            ...
            expect(mockService.ingestDocument).toHaveBeenCalledWith('/docs/spec.md', 'markdown', ['api', 'reference']);
        });
...
//# sourceMappingURL=KnowledgeBaseSkill.test.js.map