...
import type { ChatGatewayService } from '../ChatManagementSkill.js';

// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------

function createMockChatGatewayService(): ChatGatewayService {
  return {
    listChats: vi.fn(),
    createChat: vi.fn(),
    switchChat: vi.fn(),
...
describe('ChatManagementSkill', () => {
  let skill: ChatManagementSkill;
  let mockService: ChatGatewayService;
